...
def main():
    ...
    # The output file generated by adapt_voxel_recolor.py follows this naming pattern:
    ...
    # Paths for the generated PC and 3DGS files
    ...
    # Get the number of training iterations from the command-line arguments
    iterations = args.iterations
    
    # Set retrain_mode (check lowercase version)
    ...
    if retrain_mode == "pc":
        ...
        for iteration in range(5000, 60001, 5000):
            render_command = [
                "python",
                render_script_path,
                "-m", model_path,
        ...
        # --- Retrain 3DGS mode ---
        # Define the directory where retrain_3DGS scripts are located (assumed to be at root_path/code_Adaptive/retrain_3DGS)
        ...
        colmap_path = os.path.join(root_path, "colmap_dataset", args.dataset_name)
        # Use the 3DGS ply file generated by adapt_voxel_recolor.py as the start_pointcloud parameter
        ...
        # Rendering command loop
        for iteration in range(1000, 5001, 30000):
            render_command = [
                "python",
                render_script_path,
                "-m", model_path,
